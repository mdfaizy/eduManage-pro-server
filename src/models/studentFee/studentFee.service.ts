...
import repo from "./studentFee.repository";
...
class StudentFeeService {
  ...
  async generateWithTransaction(
    ...
    console.log(
      "StudentFeeService.generateWithTransaction()"
    );

    return repo.generateWithTransaction(
      tx,
      data
    );
  }
  ...
  async getDueFees(
    ...
    return repo.getDueFees(schoolId);
  }

  // =====================================
  // GET ONE FEE FOR PAYMENT
  // =====================================
  ...
  async getStudentFeeForPayment(
    ...
    return repo.getStudentFeeForPayment(
      studentFeeId,
      schoolId
    );
  }
...
export default new StudentFeeService();